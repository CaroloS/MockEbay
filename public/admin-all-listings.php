                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav ml-auto navbar-right">
                            ...
                            <li class="dropdown no-arrow nav-item"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                ...
                                <span><?php echo $_SESSION['firstName'] . "  " . $_SESSION['lastName'];?></span> <i class="icon-user fa"></i> <i class=" icon-down-open-big fa"></i></a>
                                <ul class="dropdown-menu user-menu dropdown-menu-right">
                                    <li class="active dropdown-item"><a href="personalpage.php"><i class="icon-home"></i> Personal Home
                                    </a>
                                    </li>
                                    <li class="dropdown-item"><a href="admin-all-users.php"><i class="icon-user fa"></i> All Users </a>
                                    </li>
                                    <li class="dropdown-item"><a href="admin-all-listings.php"><i class="icon-folder-close"></i> All Listings
                                    </a>
                                    </li>
